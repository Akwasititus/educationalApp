...
class DataResultsScreen extends StatefulWidget {
  final List<DataQuestion> questions;
  final Map<int, int> selectedAnswers;

  const DataResultsScreen({
    super.key,
  ...
  @override
  _DataResultsScreenState createState() => _DataResultsScreenState();
}

class _DataResultsScreenState extends State<DataResultsScreen> {
